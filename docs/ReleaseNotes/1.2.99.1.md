...
tags: On DemandFuelCells,release-notes,kerbal,ksp,zer0Kerbal,zedK
layout: page
---
...
* <OnDemandFuelCells.dll> v1.2.99.100 --> 1.2.99.101

<div style="border:0.5px solid Tomato; background-color: #bada55; color: #FF0000; text-align:center"><h4>
<b>For best results - DO A CLEAN INSTALL; DELETE EXISTING INSTALLATION THEN RE-INSTALL</b></h4><p>Download from <a href="https://www.curseforge.com/kerbal/ksp-mods/MOD-NAME/files">CurseForge</a></p></div>
...
* [youtube](https://youtu.be/Bbc3iccGVJg)
...
<div style="border:0.5px solid #BADASS; background-color: lightgrey; color: #FF0000; text-align:center">compiled with: KSP 1.12.4 — .NET 4.5.2 — C# 5.0</div>
...
[MOD:shd:stat]: https://img.shields.io/badge/On%20Demand%20Fuel%20Cells%20(ODFC)%20-v1.2.99.1--prerelease-BADA55.svg?style=plastic&labelColor=darkgreen/ "1.2.99.1-prerelease"
